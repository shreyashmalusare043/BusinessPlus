      ...
      <Card>
        <CardContent className="p-0">
          <div ref={printRef} className="bg-white text-black">
            {/* Header with Logo */}
            <div className="flex items-start justify-between mb-6 pb-4 border-b-2 border-black gap-4">
              <div className="flex-1">
                ...
                {company?.contact_email && <p className="text-sm break-words">Email: {company.contact_email}</p>}
              </div>
